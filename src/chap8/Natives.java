...
public class Natives {
    public Enviroment enviroment(Enviroment env){
        appendNatives(env);
        return env;
    }

    protected void appendNatives(Enviroment env) {
    ...
    protected void append(Enviroment env,String name,Class<?> clazz,String methodName,Class<?> ... params){
        Method m;
        try {
